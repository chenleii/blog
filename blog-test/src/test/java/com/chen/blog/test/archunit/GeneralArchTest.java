package com.chen.blog.test.archunit;

import com.chen.blog.core.sharedkernel.ddd.annotation.*;
 ...
 * @since 2020/07/21
 */
@AnalyzeClasses(packages = "com.chen.blog.core")
public class GeneralArchTest {
    ...
    public static final ArchRule domain_should_not_access_port =
            noClasses().that().resideInAPackage("..domain.model..")
                    .and()
                    .areNotAnnotatedWith(DomainFactory.class)
                    .and()
                    .areNotAnnotatedWith(DomainService.class)
    ...
    public static final ArchRule port_should_not_access_domain_service_entity =
            noClasses().that().resideInAPackage("..port..")
                    .should().dependOnClassesThat().areAnnotatedWith(DomainService.class)
                    .orShould().dependOnClassesThat().areAnnotatedWith(DomainFactory.class)
